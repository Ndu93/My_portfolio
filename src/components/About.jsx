...
const About = () => {
  return (
    <div
      name="about"
      className="w-full bg-gradient-to-b from-gray-800 to-black text-white pt-20 md:pt-6 p-11 pb-[11rem] sm:pb-0 ">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-screen pb-16">
        ...
        <p className="text-xl mt-10 leading-10">
          ...
          <br />I am excited about the possibilities that lie ahead in the world
          of software development and am eager to be a part of shaping the
          digital future. If you're looking for a dedicated and versatile
          ...
          <br />I also a CCTV Engineer and a Solar energy consultant
        </p>
      </div>
    </div>
  );
