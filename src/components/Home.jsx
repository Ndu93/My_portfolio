...
const home = () => {
  return (
    <div
      name="home"
      className="w-full h-full bg-gradient-to-b from-black via-black to-gray-800 pt-[50px] md:pt-8 px-6 pb-[24rem] sm:pb-16 lg:pb-0">
      <div className="max-w-screen-lg w-full mx-auto flex flex-col gap-12 items-center justify-center px-4 md:flex-row pt-[110px]">
        <div className="flex flex-col justify-center h-full max-w">
          ...
          <p className="text-sm sm:text-xl lg:text-justify w-full text-start text-white py-4 max-w-md leading-7">
