  ...
  return (
    <div
      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row w-full h-full px-10 gap-20">
          <div className="flex w-ful justify-center items-center flex-col md:mr-20">
            ...
            <div className="flex justify-start items-center">
              <img
                ...
                alt="phone"
              />
              <a href="tel:+2347033126790" className="p-text">
                +2347033126790
              </a>
            </div>
          </div>
          ...
          <div className="flex w-full justify-center items-center">
            <form
              ...
              <button className="text-wwhite font-bold bg-gradient-to-b from-red-500 to-yellow-800 px-6 py-4 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
                Send message
              </button>
            </form>
          </div>
